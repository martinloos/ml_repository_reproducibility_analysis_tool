...
- Average length scoring (score: 0.0 out of 1.0): We determined that 82 or more lines are best. We found 11.0 lines (in average) in the README file(s)
...
4. Source-code-comment-ratio scoring (score: 1.0 out of 1.0): We measured a average ratio of 7.84. We consider a ratio below 8.73 as best. But more comments are fine too (which would make the ratio smaller). Well documented code is important.
