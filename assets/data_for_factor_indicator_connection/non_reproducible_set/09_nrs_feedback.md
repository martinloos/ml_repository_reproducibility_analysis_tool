...
| ----------- | ----------- |
| Source-code availability and documentation |  0.13 |
...
3. Source-code pylint scoring (score: 0.26 out of 1.0): Not normalized pylint rating is 1.5 where 10.0 is best. We found that readable code is best for reproducibility and consider ratings over 5.71 as desirable.

4. Source-code-comment-ratio scoring (score: 1.0 out of 1.0): We measured a average ratio of 5.61. We consider a ratio below 8.73 as best. But more comments are fine too (which would make the ratio smaller). Well documented code is important.
