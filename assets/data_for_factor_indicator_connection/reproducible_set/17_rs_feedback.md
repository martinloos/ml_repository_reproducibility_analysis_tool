...
| ----------- | ----------- |
| Source-code availability and documentation |  0.89 |
| Software environment |  0.8 |
...
2. README overall scoring (score: 0.98 out of 1.0): See sub-ratings for more information.

- Average length scoring (score: 0.97 out of 1.0): We determined that 82 or more lines are best. We found 80.5 lines (in average) in the README file(s)
- Average accessible links scoring (score: 1.0 out of 1.0): We determined that 4 or more links are best. We found 4.5 accessible links (in average) in the README file(s)
3. Source-code pylint scoring (score: 1.0 out of 1.0): Not normalized pylint rating is 6.4 where 10.0 is best. We found that readable code is best for reproducibility and consider ratings over 5.71 as desirable.

4. Source-code-comment-ratio scoring (score: 0.0 out of 1.0): We measured a average ratio of 52.5. We consider a ratio below 8.73 as best. But more comments are fine too (which would make the ratio smaller). Well documented code is important.
