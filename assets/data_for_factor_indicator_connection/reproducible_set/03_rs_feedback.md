...
| ----------- | ----------- |
| Source-code availability and documentation |  0.98 |
...
- Average length scoring (score: 1.0 out of 1.0): We determined that 82 or more lines are best. We found 141.0 lines (in average) in the README file(s)
- Average accessible links scoring (score: 1.0 out of 1.0): We determined that 4 or more links are best. We found 13.000399999999999 accessible links (in average) in the README file(s)
...
4. Source-code-comment-ratio scoring (score: 1.0 out of 1.0): We measured a average ratio of 1.36. We consider a ratio below 8.73 as best. But more comments are fine too (which would make the ratio smaller). Well documented code is important.
...
2. Strictly defined libraries in config file(s) scoring (score: 0.2 out of 0.2): We expect that 100% of the defined libraries in the config file(s) are strictly (==) defined. We found 9 libraries in the config file(s). From these 100.0% were strictly specified.
...
Random seed lines with fixed seed scoring (score: 1.0 out of 1.0): We found that 100.0% of the 11 found random seed declaration lines had a fixed seed. If the value is not 100% make sure to fix the random seeds.
